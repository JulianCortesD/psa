...
<div class="col-8">
  ...
  <p>&nbsp;</p>
                  <h1 class="titulo-seccion">¿Quiénes Somos?</h1>

                <p align="justify"><style=.padding-left="50"><br>El Portal de Salud Ambiental de Bogotá D.C., es un centro de refrencia a nivel distrital para el abordaje interseciona y en análisis integral de los determinantes socio ambientales del proceso salud enfermedad en la ciudad. Tiene como propósito integrar, promover y apoyar esfuerzos distritales de carácter técnico, político y social tendientes a la conservación del ambiente como estrategia de mejoramiento de las condiciones de salud y la calidad de vida de los bogotanos.</br>
                </p>
<p>&nbsp;</p>
                <div class="centrado">
...
<p>&nbsp;</p>
                   <h4 class="subtitulo-seccion">Objetivo General</h4>
                    ...
                    habitantes del Distrito Capital.</br>
                     ...
                     <h4 class="subtitulo-seccion">Objetivo Especificos</h4>

                  <p align="justify"><style=.fluid-left:"50px"><br> Desarrollar un modelo de planificación, gestión, seguimiento y evaluación distrital y territorial que permita fortalecer financiera, técnica y administrativamente los procesos de salud ambiental.</br>
