        ...
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-8">
                    ...
                    <span class="breadcrumb_ espacio">Radiación electromagnética</span>
                </div>  
                <div class="col-4">
                    <div class="row">
            ...
            <div class="row" style="text-align:justify;">
                ...
                <div class="contenidoSecAmb centradoDiv">
                    ...
                    <div>
                    <img src="images/espacio/espacioMAPA.jpg" width="85" height="63" alt="Calidad aire" />
                    <h1 class="seccion fondoEspacio sinSaltoLinea">Radiación electromagnética</h1>
                    </div>

                    <h1 class="centrado colorEspacio mt20">CAMBIO CLIMÁTICO</h1>

                    <h2 class="centrado colorEspacio mt20">¿Qué hacemos?</h2>
                    ...
                    <h3 class="seccion fondoEspacio mt40">Indicadores</h3>
                    <div class="logos">
                    <div class="seccionIcono">
                        <img src="images/espacio/espacio1INDICADORES.jpg" width="85" height="63" alt="indicadores aire" />
                    </div>
                    ...
                    <li>Eventos notificados de ESI-IRAG en temporada de lluvias en Bogotá D.C. este indicador está disponible en el enlace:
                        <a href="http://saludata.saludcapital.gov.co/osb/index.php/datos-de-salud/salud-ambiental/temporadalluvias/" class="colorEspacio">http://saludata.saludcapital.gov.co/osb/index.php/datos-de-salud/salud-ambiental/temporadalluvias/</a>
                    </li>
                    <li>
                        <a href="http://saludata.saludcapital.gov.co/osb/index.php/datos-de-salud/salud-ambiental/tbogota/" class="colorEspacio">Temperatura en Bogotá D.C.</a> este indicador está disponible en el enlace:
                        <a href="http://saludata.saludcapital.gov.co/osb/index.php/datos-de-salud/salud-ambiental/tbogota/"
                        class="colorEspacio">http://saludata.saludcapital.gov.co/osb/index.php/datos-de-salud/salud-ambiental/tbogota/</a>
                    </li>
                    </ul>

                    <h3 class="seccion fondoEspacio mt40">Normatividad</h3>
                    <div class="logos">
                    <div class="seccionIcono">
                        <img src="images/espacio/espacioNORMATIVIDAD.jpg" width="85" height="63" alt="Normatividad cambio climático" />
                    </div>
                    ...
                    <h3 class="seccion fondoEspacio mt40">Documentos e investigaciones</h3>
                    <div class="logos">
                    <div class="seccionIcono">
                        <img src="images/espacio/espacioDOCUMENTOS.png" width="85" height="63" alt="Documentos e investigaciones cambio climático"
                        />
                    </div>
                    <div class="sinSaltoLinea">Compilación de las normas expedidas por las diferentes organizaciones gubernamentales relacionadas con las acciones
                        de mitigación y adaptación a los fenómenos asociados a la variabilidad y cambio climático que se presentan en Bogotá
                    ...
                    <li>Boletín clima y salud. Gobierno de Colombia. Edición N°5 de 2019. Link:
                        ...
                        class="colorEspacio">http://www.pronosticosyalertas.gov.co/boletines-e-informes-tecnicos</a>
                    </li>
                    </ul>
