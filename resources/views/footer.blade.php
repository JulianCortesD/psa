<footer class="min-ancho mt80">
        ...
        <div class="content-wrapper">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 fondo-aliados" >
                            {{-- <img src="{{asset("images/footer/FondoAliadosEstrategicos.svg")}}" alt="Alcaldía Bogotá" style="height: 209px; width: 100%; position: absolute; margin-left: -15px;"> --}}
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="row footer-alcaldia justify-content-between">
                        <div class="col-4">
                            <p style="color:white;">
                                ...
                                lunes a viernes 9:30 a.m. a 7:00 p.m. <br>
                                Bogotá-Colombia
                            </p>
                        </div>
                        <div class="col-4 mt-3 mr-3 texto-derecho">
