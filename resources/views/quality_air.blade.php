        ...
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-8">
                    ...
                    <span class="breadcrumb_"> | Aire, ruido y radiación electromagnética | Calidad del aire</span>
                </div>  
                <div class="col-4">
                    <div class="row">
            ...
            <div class="row">
                <div class="contenidoSecAmb centradoDiv">
                    ...
                    <p>La Secretaria Distrital de Salud realiza el monitoreo de la información sobre las condiciones de exposición a contaminación
                        ...
                        de riesgo.</p>
                    <a href="{{asset("aire_calidad_contaminacion")}}" class="verMas colorAire" >Ver más</a>
                
                
                
                    <h3 class="centrado colorAire">IBOCA</h3>
                    <p>Índice Bogotano del Calidad de Aire (IBOCA): Aquí encontrara la información en tiempo real referente al índice bogotano
                        de calidad de aire, modelación de calidad del aire y datos de inmisión (contaminantes criterio).</p>
                        <a href="{{asset("aire_calidad_iboca")}}" class="verMas colorAire" >Ver más</a>
                    ...
                    <p>La Secretaría Distrital de Salud realiza la inspección y vigilancia de la Ley 1335 de 2009 a establecimientos públicos,
                        ...
                        <a href="{{asset("aire_calidad_tabaco")}}" class="verMas colorAire" >Ver más</a>
                    ...
                    <p>La Secretaría Distrital de Salud realiza la vigilancia epidemiológica, ambiental y sanitaria de la contaminación auditiva
                        ...
                        de riesgo.</p>
                    <a href="{{asset("aire_calidad_ruido")}}" class="verMas colorAire">Ver más</a>
                
                
                
                    <h1 class="colorAire mt40 centrado">Radiación electromagnética</h1>
                    <p>La Secretaría Distrital de Salud realiza la vigilancia sanitaria, ambiental y epidemiológica de la exposición poblacional
                    ...
                    <a href="{{asset("aire_calidad_radiacion")}}" class="verMas colorAire">Ver más</a>
